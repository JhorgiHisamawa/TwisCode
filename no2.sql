CREATE TABLE detail_transaksi (id serial NOT NULL, id_transaksi serial NOT NULL, Harga INT NOT NULL, Jumlah INT NOT NULL, Subtotal INT NOT NULL, CONSTRAINT fk_transaksi FOREIGN KEY (id)  REFERENCES transaksi(id));
